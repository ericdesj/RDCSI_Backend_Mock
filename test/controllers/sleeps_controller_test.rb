...
class SleepsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sleep" do
    assert_difference('Sleep.count') do
      post sleeps_url, params: { sleep: { duration: @sleep.duration, quality: @sleep.quality, times_awake: @sleep.times_awake, user_id: @sleep.user_id } }
    end
  ...
  test "should update sleep" do
    patch sleep_url(@sleep), params: { sleep: { duration: @sleep.duration, quality: @sleep.quality, times_awake: @sleep.times_awake, user_id: @sleep.user_id } }
